 ...
 * @author Usuario
 */
public class Proyectito extends javax.swing.JFrame {

    private String[] args;

    /**
     * Creates new form Proyectito
     */
    public Proyectito() {
        initComponents();
    }
    ...
    //Crea cuadrado
    Proyecto2.BorrarCirculo(mainPanel.getGraphics(), 200, 50, 50, 50);
    Proyecto2.HacerCuadrado(mainPanel.getGraphics(), 50, 50, 50, 50);//Derecha,Abajo,largo,alto
    }//GEN-LAST:event_RB1MouseClicked

    private void RB2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RB2MouseClicked
    //Crea circulo
    Proyecto2.BorrarCuadrado(mainPanel.getGraphics(), 50, 50, 50, 50);
    Proyecto2.HacerCirculo(mainPanel.getGraphics(), 200, 50, 50, 50);//Derecha,Abajo,largo,alto
    }//GEN-LAST:event_RB2MouseClicked

    private void RB3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RB3MouseClicked
    //Crea circulo y cuadrado
    Proyecto2.HacerCuadrado(mainPanel.getGraphics(), 50, 50, 50, 50);//Derecha,Abajo,largo,alto
    Proyecto2.HacerCirculo(mainPanel.getGraphics(), 200, 50, 50, 50);//Derecha,Abajo,largo,alto
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Proyectito.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Proyectito().setVisible(true);
            }
        });
    }
