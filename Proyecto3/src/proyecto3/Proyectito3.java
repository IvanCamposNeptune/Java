 ...
 * @author Usuario
 */
public class Proyectito3 extends javax.swing.JFrame {

    /**
     * Creates new form Proyectito3
     */
    public Proyectito3() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Proyectito3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Proyectito3().setVisible(true);
            }
        });
    }
